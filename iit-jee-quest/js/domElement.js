window.addEventListener('load', function () {
	 ...
	 */
	var divRootContainerElement = this.createHtmlElement({
		"eType": "div", "id": "rootContainer", "style": {
	...
	createAnswerElement = function (index, answerString) {
		...
		return this.createHtmlElement({
			"eType": "div", "id": "divAnswer" + index, "textValue": text, "style": {
				background: "#FFFFEE",
	...
	main = function () {
		...
		var buttonPostYourQuestion = this.createHtmlElement({ "eType": "button", "id": "btnIdPostQuestion", "class": "postYourAnswerBtn", "textValue": "Post Your Question", "style": { "display": "none" } });
		this.appendToElement(divTextAreaWrapper, buttonPostYourQuestion);
		buttonPostYourQuestion = null; // clear the reference and notify the GC

		// cancel your question button
		var buttonCancelYourQuestion = this.createHtmlElement({ "eType": "button", "id": "btnIdCancelQuestion", "class": "postYourAnswerBtn", "textValue": "Cancel", "style": { "display": "none" } });
		this.appendToElement(divTextAreaWrapper, buttonCancelYourQuestion);
		buttonCancelYourQuestion = null; // clear the reference and notify the GC
	}.bind(this)();
